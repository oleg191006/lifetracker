/**
 * Bootstrap file for the Log micro-frontend.
 *
 ...
 * LogPage inside its own router. When loaded by the host shell
 * via Module Federation, only the exposed LogPage component
