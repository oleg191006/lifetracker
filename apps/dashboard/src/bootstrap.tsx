/**
 * Bootstrap file for the Dashboard micro-frontend.
 *
 ...
 * DashboardPage inside its own router. When loaded by the host shell
 * via Module Federation, only the exposed DashboardPage component
